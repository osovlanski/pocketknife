...
import { Mail, Briefcase, Plane, BookOpen, Wrench, ShoppingCart } from 'lucide-react';
...
const App = () => {
  const [activeTab, setActiveTab] = useState<'email' | 'jobs' | 'travel' | 'learning' | 'groceries'>('email');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex gap-1">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-6 py-4 font-semibold transition-all ${
                activeTab === 'groceries'
                  ? 'bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 border-b-2 border-emerald-400 text-white'
                  : 'text-slate-400 hover:text-white hover:bg-white/5'
              }`}
            >
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        {activeTab === 'groceries' && <GroceriesAgent />}
      </div>
    </div>
  );
};
